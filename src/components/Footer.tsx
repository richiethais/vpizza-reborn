      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="border-t border-primary-foreground/20 pt-6 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-5">
            ...
            <a href="https://www.facebook.com/fatboyfriedrice" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/60 hover:text-secondary transition-colors" aria-label="Facebook">
            ...
            <a href="https://www.tiktok.com/@fatboyfriedrice" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/60 hover:text-secondary transition-colors" aria-label="TikTok">

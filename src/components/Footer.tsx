      ...
      <div className="max-w-5xl mx-auto">
        ...
        <div className="grid grid-cols-1 md:grid-cols-2 gap-8 mb-8">
          ...
          <div className="flex flex-col gap-6">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <a href="https://www.google.com/maps/search/?api=1&query=11450+Beach+Blvd+Jacksonville+FL" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-primary-foreground/90 hover:text-secondary text-sm transition-colors underline">
                <MapPin size={14} className="text-secondary shrink-0" />
                11450 Beach Blvd, Jacksonville, FL
              </a>
              <a href="tel:+17819718865" className="flex items-center gap-2 text-primary-foreground/90 hover:text-secondary text-sm transition-colors">
            ...
            <div className="flex flex-col gap-1.5">
              ...
              <a href="https://www.google.com/maps/search/?api=1&query=1429+Cassat+Avenue+Jacksonville+FL" target="_blank" rel="noopener noreferrer" className="flex items-center gap-2 text-primary-foreground/90 hover:text-secondary text-sm transition-colors underline">
                <MapPin size={14} className="text-secondary shrink-0" />
                1429 Cassat Avenue, Jacksonville, FL
              </a>
              <a href="tel:+14302455852" className="flex items-center gap-2 text-primary-foreground/90 hover:text-secondary text-sm transition-colors">
                <Phone size={14} className="text-secondary shrink-0" />
                (430) 245-5852
              </a>
              <div className="flex items-center gap-2 text-primary-foreground/90 text-sm">
        ...
        <div className="border-t border-primary-foreground/20 pt-6 flex flex-col items-center gap-4">
          ...
          <div className="flex items-center gap-5">
            <a href="https://www.instagram.com/fatboyfriedrice/" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-secondary transition-colors" aria-label="Instagram">
              <svg xmlns="http://www.w3.org/2000/svg" width="22" height="22" viewBox="0 0 24 24" fill="none" stroke="currentColor" strokeWidth="2" strokeLinecap="round" strokeLinejoin="round"><rect width="20" height="20" x="2" y="2" rx="5" ry="5"/><path d="M16 11.37A4 4 0 1 1 12.63 8 4 4 0 0 1 16 11.37z"/><line x1="17.5" x2="17.51" y1="6.5" y2="6.5"/></svg>
            </a>
            <a href="https://www.facebook.com/profile.php?id=100063763532593" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-secondary transition-colors" aria-label="Facebook">
            ...
            <a href="https://www.tiktok.com/@officialfatboyfriedrice?_r=1&_t=ZT-94Dv5npLZt7" target="_blank" rel="noopener noreferrer" className="text-primary-foreground/80 hover:text-secondary transition-colors" aria-label="TikTok">

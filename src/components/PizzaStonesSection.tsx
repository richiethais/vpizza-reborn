      ...
      <div className="max-w-5xl mx-auto flex flex-col md:flex-row gap-12 items-start">
        <div className="flex-shrink-0">
          <img
            src={pizzaStone}
            alt="Pizza on stone"
            className="w-full md:w-[350px] h-[300px] object-cover"
          />
        </div>
        <div className="flex-1">
          ...
          <div className="font-body text-foreground leading-relaxed space-y-4 text-sm mb-6">
            <p>
              Because our dough has ZERO artificial ingredients, our pizza must be eaten right out of our oven
              for true authentic flavor. If you plan on bringing one home, we strongly suggest (like really, really
              strongly) you purchase one of our pizza stones. They're only $20 and last forever. And, it's the best
              way to recreate that same V Pizza flavor at home.
            </p>
          </div>
          ...
          <p className="font-display text-secondary text-lg tracking-wider uppercase font-bold">
